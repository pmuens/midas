...
const { ChainId, Fetcher, Route, TokenAmount, TradeType, Trade, Token } = require('@uniswap/sdk')
...
class UniswapV2 extends Exchange {
  async getRate(fromToken, toToken, amount) {
    ...
    uniFromToken = new Token(ChainId.MAINNET, fromToken.address, fromToken.decimals)
